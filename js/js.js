  let currentSlide = 0;
        ...
        navbarLinks.forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                if (targetId === '#build') {
                    alert('Build Your Own feature coming soon! Contact us to discuss your custom balloon arch design.');
                    return;
                }
        ...
        document.querySelectorAll('.pricing-button').forEach(button => {
            button.addEventListener('click', (e) => {
                const packageName = e.target.textContent;
                alert(`Thank you for your interest in our ${packageName} package! We'll contact you soon to discuss your event details.`);
            });
        });
        ...
        bookingForm.addEventListener('submit', (e) => {
            ...
            alert(`Thank you, ${data.clientName}! Your booking request has been received. We'll contact you at ${data.clientEmail} within 24 hours to discuss your ${data.eventType || 'event'} details.`);
